...
function degToRad(deg)
 ...
 ---@param flags number
 ---@param ignore number Entity to ignore from raycast
 ---@param distance number Distance to raycast
 ---@return integer retval
 ---@return boolean hit True if the raycast hit something
 ---@return vector3 endCoords Position of where the raycast hit
 ---@return vector3 surfaceNormal
 ---@return integer entityHit Entity that was hit by the raycast
function screenToWorld(flags, ignore, distance)
    flags = flags or 16
    ignore = ignore or PlayerPedId()
    ...
    local to = addVector3(camPos, mulNumber(dir, distance))

    local ray = StartShapeTestRay(from.x, from.y, from.z, to.x, to.y, to.z, flags, ignore, 4)
